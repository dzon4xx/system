...
class Regulation(Base_object):
    ...
    def __init__(self, *args):
        ...
        super().__init__(*args[0:Regulation.COL_FEED_EL_ID]) # inicjalizuj id type, 
    ...
    def __check_arguments(self, out_el_id, feed_el_id, set_point, dev):
        ...
        if out_el_id not in Output_element.items.keys():
            raise Regulation_config_error('Output element: ' + out_el_id + " not in defined output elements")
